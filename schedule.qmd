...
The frontload approach completes projects one at a time in deadline order. The point of this method is to just provide a bounding case, and gives a better sence of priority, and when exactly I'd need more work if I was trying to knock everything out as soon as possible.

Both approaches assigna full day of work for each project - which I'm happy to do as a simplifying assumption.
...
Briefly, this scheduling algorithm builds a schedule by assigning days to projects based on a target “ideal days per week” computed from each project’s remaining work divided by time until its deadline. Each project has a weekly cap set to the floor of that ideal, with fractional leftovers accumulating - this effectively assings a day to a project only when I can actually work a full day on it. Fair. Among projects still under their weekly cap, we prioritize projects with earlier deadlines. Weekly tallies reset every Monday, weekends are skipped, and days can remain unassigned if no project is eligible.
...
I can already look at the paced schedule and see that I will have about a day a week or two of availability only in July. But to see that more clearly, let's see that in a plot.
...
2. Do I have too muchor too little work? *I have quite a bit already*
3. When should I start a new project? *Looks like I can't do anything new until June/July*
4. And when will I finally get to that back-burner project? Looks like it's April.
